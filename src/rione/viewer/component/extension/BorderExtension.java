...
public class BorderExtension implements EntityExtension {
	...
	public static final BorderExtension DARK_GRAY = new BorderExtension(Color.DARK_GRAY);
	...
	public static final BorderExtension LIGHT_GRAY = new BorderExtension(Color.LIGHT_GRAY);
	public static final BorderExtension MAGENTA = new BorderExtension(Color.MAGENTA);
	public static final BorderExtension ORANGE = new BorderExtension(Color.ORANGE);
	...
	public static final BorderExtension YELLOW = new BorderExtension(Color.YELLOW);
