...
java -Xms2048m -Xmx2048m -cp $TEAM_CP sample.LaunchAgents sample.agent.at.SampleAmbulanceTeam*n sample.agent.fb.SampleFireBrigade*n sample.agent.pf.SamplePoliceForce*n sample.agent.SampleCentre*n -h $HOST --loadabletypes.inspect.dir=jars --random.seed=1
